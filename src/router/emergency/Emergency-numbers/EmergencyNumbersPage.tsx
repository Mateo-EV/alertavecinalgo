...
import { FaFireExtinguisher, FaAmbulance, FaShieldAlt } from "react-icons/fa";
        ...
        <div className="p-4 text-gray-800">
            ...
            <div className="bg-white rounded-lg shadow p-4">
                ...
                <ul className="list-disc list-inside text-sm text-gray-700">
                    ...
                    <li>
                        Llame al número de emergencia apropiado según la
                        situación.
                    </li>
                    <li>
                        Proporcione información clara y precisa sobre su
                        ubicación y la emergencia.
                    </li>
                    <li>Siga las instrucciones del operador de emergencia.</li>
                    <li>
                        Si es seguro hacerlo, ayude a otros hasta que llegue la
                        ayuda profesional.
                    </li>
                </ul>
            </div>

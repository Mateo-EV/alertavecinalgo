    ...
    return (
        <div className="p-6 space-y-6 text-[var(--color-princi)]">
            ...
            <div className="bg-white/10 backdrop-blur-md shadow-lg rounded-xl p-6 border border-white/10">
                ...
                <div className="space-y-4">
                    {[
                        ...
                        { label: "Correo Electrónico", value: email, setValue: setEmail, type: "email" },
            ...
            <div className="bg-white/10 backdrop-blur-md shadow-lg rounded-xl p-6 border border-white/10">
                ...
                {[
                    { label: "Correo Electrónico", value: emailNotifications, setValue: setEmailNotifications },
                    { label: "Notificaciones Push", value: pushNotifications, setValue: setPushNotifications },
                    { label: "SMS", value: smsNotifications, setValue: setSmsNotifications },
